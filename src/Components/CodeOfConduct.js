        ...
        <div className = 'page-container'>
            ...
            <div className = 'codeofconduct'>
                ...
                <h2>Ground Rules</h2>
                    ...
                    <ul>
                        <li>No arguments directed at people – only at ideas and opinions. Disagreement should be respectful.</li>
                        <li>Listen to the whole of others’ thoughts – actually listen, rather than just running over your own response in your head.</li>
                        <li>Respect the group’s time. Try to keep your comments reasonably short and to the point, so that others have a chance to respond.</li>
                        <li>Consider all comments seriously, and try to evaluate them fairly. Others’ ideas and comments may change your mind, or vice versa: it’s important to be open to that.</li>
                        <li>If someone disagrees with you then evaluate both positions, and only continue to argue for yours if you continue to believe it’s right. Our discussions are about learning, so try to be open to disagreement rather than defensive.</li>
                        <li>Everyone is responsible for following the ground rules, and should help uphold them where they feel able to do so. The organisers may take any action they deem appropriate, including warning the offender or expulsion from the meetup.</li>
                </ul>
        
                <h2>Harassment Free Meetup</h2>
                ...
                <h2>Disclaimer</h2>
                    The ground rules are based on <a href ='www.codecraftuk.org' alt='Code Craft'> Code Craft's Ground Rules</a>.
                    The anti-harassment policy is based on the example policy from the <a href = 'https://geekfeminism.wikia.org/wiki/Geek_Feminism_Wiki' alt = 'Geek Feminism'> Geek Feminism Wiki </a>
